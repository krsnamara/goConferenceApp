...
func main() {
	conferenceName := "Go Conference" //syntaxtic sugar allows the variable to be defined in this way. does not work for const
	const conferenceTickets = 50
	var remainingTickets uint = 50
	// var bookings [50]string // this was first written as an array with limited number of entries
	bookings := []string{}
